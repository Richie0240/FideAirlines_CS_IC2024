 ...
 * @author ricar
 */
public class VueloAgregado extends javax.swing.JFrame {
    ...
    public VueloAgregado() {
        initComponents();
        this.setLocationRelativeTo(null);
        Hilo_VueloAgregado starthilo = new Hilo_VueloAgregado(this);
        starthilo.start();
    }
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Vuelo agregado exitosamente!");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 530, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueloAgregado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VueloAgregado().setVisible(true);
            }
        });
    }
