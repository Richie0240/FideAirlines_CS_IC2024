 ...
 * @author ricar
 */
public class Hilo_ReservaCancelada extends Thread {
    ...
    public Hilo_ReservaCancelada(JFrame ventanaAmostrar, Usuario user, Vuelos vuelo, Reserva reserva) {
    ...
    public void run() {
        ...
        try {
            ...
            Hilo_ReservaCancelada.sleep(3000);
...
//            abrirInicioSesion.setVisible(true);
            ...
            Logger.getLogger(Hilo_ReservaCancelada.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
