 ...
 * @author ricar
 */
public class UsuarioNoAutorizado extends javax.swing.JFrame {
...
//        starthilo.start();
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 520, 60));
        ...
        lbl_error1.setFont(new java.awt.Font("Roboto Light", 0, 24)); // NOI18N
        lbl_error1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_error1.setText("Usted no es un usuario administrador");
        jPanel1.add(lbl_error1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 520, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioNoAutorizado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuarioNoAutorizado().setVisible(true);
            }
        });
    }
