 ...
 * @author ricar
 */
public class PreferenciasActualizadas extends javax.swing.JFrame {
    ...
    public PreferenciasActualizadas(Usuario user) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.user = user;
        Hilo_PreferenciasActualizadas newhilo = new Hilo_PreferenciasActualizadas(user, this);
        newhilo.start();
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Sus preferencias han sido actualizadas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreferenciasActualizadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreferenciasActualizadas(null).setVisible(true);
            }
        });
    }
