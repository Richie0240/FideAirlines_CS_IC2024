 ...
 * @author ricar
 */
public class ReservacionyaCancelada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Ya se encuentra cancelada esta reservación");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservacionyaCancelada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservacionyaCancelada().setVisible(true);
            }
        });
    }
