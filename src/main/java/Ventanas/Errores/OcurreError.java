 ...
 * @author ricar
 */
public class OcurreError extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Ha ocurrido un error, intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 470, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OcurreError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OcurreError().setVisible(true);
            }
        });
    }
