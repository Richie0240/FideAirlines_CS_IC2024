 ...
 * @author ricar
 */
public class ApellidosIncorrectos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Verifique sus apellidos e intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 490, 60));
        ...
        jLabel1.setFont(new java.awt.Font("Roboto Thin", 2, 12)); // NOI18N
        jLabel1.setText("Consejo: Puedes ingresar uno o dos apellidos, asegurate de escribirlos correctamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApellidosIncorrectos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApellidosIncorrectos().setVisible(true);
            }
        });
    }
