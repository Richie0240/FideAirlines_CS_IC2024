 ...
 * @author ricar
 */
public class contraseniasDiferentes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 340, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contraseniasDiferentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new contraseniasDiferentes().setVisible(true);
            }
        });
    }
