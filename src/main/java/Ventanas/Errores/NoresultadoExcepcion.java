 ...
 * @author ricar
 */
public class NoresultadoExcepcion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("No hay vuelos con esos criterios de busqueda");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 530, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoresultadoExcepcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoresultadoExcepcion().setVisible(true);
            }
        });
    }
