 ...
 * @author ricar
 */
public class NombreIncorrecto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Nombre incorrecto, intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 490, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NombreIncorrecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NombreIncorrecto().setVisible(true);
            }
        });
    }
