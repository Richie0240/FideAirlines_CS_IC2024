 ...
 * @author ricar
 */
public class SeleccioneUnVuelo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Seleccione un vuelo primero e intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 580, 60));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccioneUnVuelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccioneUnVuelo().setVisible(true);
            }
        });
    }
