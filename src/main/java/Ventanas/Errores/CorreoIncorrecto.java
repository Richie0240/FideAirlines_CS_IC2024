 ...
 * @author ricar
 */
public class CorreoIncorrecto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Correo electronico incorrecto, intente nuevamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CorreoIncorrecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CorreoIncorrecto().setVisible(true);
            }
        });
    }
