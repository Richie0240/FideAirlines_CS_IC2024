 ...
 * @author ricar
 */
public class CredencialesIncorrectas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_error.setText("Revise las credenciales, intente nuevamente");
        jPanel1.add(lbl_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 540, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CredencialesIncorrectas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CredencialesIncorrectas().setVisible(true);
            }
        });
    }
